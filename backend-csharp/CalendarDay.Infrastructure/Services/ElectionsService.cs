...
public class ElectionsService(CalendarDayDbContext db) : IElectionsService
{
    ...
    public async Task<IReadOnlyList<ElectionDto>> GetAllAsync(CancellationToken ct)
    {
        ...
        return elections.Select(e =>
        {
            ...
            return new ElectionDto(e.Id, e.Title, e.IsActive, e.ShowInArchive, e.Eday, HasDocument(e), TypeIdsSnapshot(e), doc.Name, doc.Url, doc.SizeBytes);
        }).ToList();
    }

    /// <summary>Toate scrutinele inactive (folosit și de panoul de admin pentru gestionare).</summary>
    ...
    public async Task<IReadOnlyList<ElectionDto>> GetArchivedAsync(CancellationToken ct)
    {
        var elections = await db.Elections
            .Where(e => e.ShowInArchive)
            .OrderByDescending(e => e.Eday)
            .ToListAsync(ct);
        return elections.Select(e =>
        {
    ...
    public async Task<ElectionDto?> GetByIdAsync(Guid id, CancellationToken ct)
    {
        ...
        return new ElectionDto(entity.Id, entity.Title, entity.IsActive, entity.ShowInArchive, entity.Eday, HasDocument(entity), TypeIdsSnapshot(entity), doc.Name, doc.Url, doc.SizeBytes);
    }
    ...
    public async Task<ElectionDto> CreateAsync(CreateElectionDto dto, CancellationToken ct)
    {
        ...
        var entity = new Election
        {
            ...
            ShowInArchive = dto.ShowInArchive,
            Eday = dto.Eday,
        ...
        return new ElectionDto(entity.Id, entity.Title, entity.IsActive, entity.ShowInArchive, entity.Eday, HasDocument(entity), TypeIdsSnapshot(entity), createdDoc.Name, createdDoc.Url, createdDoc.SizeBytes);
    }
    ...
    public async Task<ElectionDto?> UpdateAsync(Guid id, UpdateElectionDto dto, CancellationToken ct)
    {
        ...
        entity.ShowInArchive = dto.ShowInArchive;
        ...
        return new ElectionDto(entity.Id, entity.Title, entity.IsActive, entity.ShowInArchive, entity.Eday, HasDocument(entity), TypeIdsSnapshot(entity), updatedDoc.Name, updatedDoc.Url, updatedDoc.SizeBytes);
    }
